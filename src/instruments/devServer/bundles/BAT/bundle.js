...
(function () {
	...
	*/
	...
	const BatDisplay = ({
	  ...
	  const [voltage] = useSimVar("L:A32NX_ELEC_BAT_".concat(number, "_POTENTIAL"), 'Volts', 200);
	  return /*#__PURE__*/jsxRuntime.jsx("text", {
	    x: x,
	    y: y,
	    children: ltsTest ? '88.8V' : "".concat(voltage.toFixed(1), "V")
	  });
	};

	const BatRoot = () => /*#__PURE__*/jsxRuntime.jsxs("svg", {
	  className: "bat-svg",
	  viewBox: "0 0 200 100",
	  children: [/*#__PURE__*/jsxRuntime.jsx(BatDisplay, {
	    number: 1,
	    x: "184",
	    y: "45"
	  }), /*#__PURE__*/jsxRuntime.jsx(BatDisplay, {
	    number: 2,
	    x: "184",
	    y: "95"
	  })]
	...
	render( /*#__PURE__*/jsxRuntime.jsx(BatRoot, {}));
