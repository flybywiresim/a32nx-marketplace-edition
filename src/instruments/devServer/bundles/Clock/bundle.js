...
(function () {
	...
	*/
	...
	const getDisplayString$1 = (seconds, running) => seconds == null ? '' : "".concat(Math.floor(Math.min(seconds, 5999) / 60).toString().padStart(2, '0')).concat(running ? ':' : ' ').concat(Math.floor(Math.min(seconds, 5999) % 60).toString().padStart(2, '0'));
	...
	const Chrono = () => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx("text", {
	    ...
	    y: "60",
	    className: "fontBig",
	    children: ltsTest ? '88:88' : getDisplayString$1(elapsedTime, running)
	  });
	};
	...
	const Clock = () => {
	  ...
	  if (!dateMode) {
	    ...
	    text1 = "".concat(displayTime[0].toString().padStart(2, '0'), ":").concat(displayTime[1].toString().padStart(2, '0'));
	    text2 = displayTime[2].toString().padStart(2, '0');
	  } else {
	    text1 = "".concat(monthOfYear.toString().padStart(2, '0'), ":").concat(dayOfMonth.toString().padStart(2, '0'));
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
	    children: [/*#__PURE__*/jsxRuntime.jsx("text", {
	      ...
	      y: "153",
	      className: "fontBig",
	      children: ltsTest ? '88:88:' : text1
	    }), /*#__PURE__*/jsxRuntime.jsx("text", {
	      x: "190",
	      y: "147",
	      className: "fontSmall",
	      children: ltsTest ? '88' : text2
	    })]
	  });
	};

	const getDisplayString = (seconds, running) => seconds === 0 && !running ? '' : "".concat(Math.floor(Math.min(seconds, 359940) / 3600).toString().padStart(2, '0')).concat(running ? ':' : ' ').concat(Math.floor(Math.min(seconds, 359940) % 3600 / 60).toString().padStart(2, '0'));
	...
	const ElapsedTime = () => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx("text", {
	    ...
	    y: "247",
	    className: "fontBig",
	    children: ltsTest ? '88:88' : getDisplayString(elapsedTime, elapsedKnobPos === 0)
	  });
	};
	...
	const ClockRoot = () => {
	  ...
	  return dcEssIsPowered || dcHot1IsPowered ? /*#__PURE__*/jsxRuntime.jsxs("svg", {
	    version: "1.1",
	    viewBox: "0 0 256 256",
	    xmlns: "http://www.w3.org/2000/svg",
	    children: [/*#__PURE__*/jsxRuntime.jsx(Chrono, {}), /*#__PURE__*/jsxRuntime.jsx(Clock, {}), /*#__PURE__*/jsxRuntime.jsx(ElapsedTime, {})]
	  }) : null;
	};

	render( /*#__PURE__*/jsxRuntime.jsx(ClockRoot, {}));
