...
(function () {
	...
	*/
	...
	const getBco16FromDigits = digits => digits[0] * 4096 + digits[1] * 256 + digits[2] * 16 + digits[3];

	const PoweredXpdrDisplay = () => {
	  const [newDigits, setNewDigits] = react.useState(null);
	  const [clrPressed, setClrPressed] = react.useState(false);
	  const [displayResetTimer, setDisplayResetTimer] = react.useState(-1);
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx("svg", {
	    ...
	    children: /*#__PURE__*/jsxRuntime.jsx("text", {
	      x: "15%",
	      y: "45%",
	      children: ltsTest ? '8888' : codeInDisplay.join('')
	    })
	  });
	};
	...
	const XpdrRootDisplay = () => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx(PoweredXpdrDisplay, {});
	};

	render( /*#__PURE__*/jsxRuntime.jsx(XpdrRootDisplay, {}));
